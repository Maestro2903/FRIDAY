...
export const ENUM_OPTIONS: Record<string, string[]> = {
  ...
  // Assistant persona: 'jarvis' (male, British butler) or 'friday' (female,
  // warm). Selects the SOUL persona + the fast voice-reply prompt; pick the
  // matching voice separately via the tts.* settings.
  'voice.persona': ['jarvis', 'friday'],
