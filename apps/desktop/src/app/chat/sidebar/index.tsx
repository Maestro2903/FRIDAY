...
import { type AppView, ARTIFACTS_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE, VOICE_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'voice', label: 'Voice', icon: props => <AudioLines {...props} />, route: VOICE_ROUTE }
]
            ...
            <SidebarMenu className="gap-px">
              {SIDEBAR_NAV.map(item => {
                ...
                const active =
                  ...
                  (item.id === 'voice' && currentView === 'voice')
