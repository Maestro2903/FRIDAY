/**
 * ElevenLabs UI — Shimmering Text  (vendored from https://ui.elevenlabs.io,
 * r/shimmering-text.json). Only the `cn` import path was adjusted to the
 * Hermes dashboard alias. Upstream logic is unchanged.
 */
